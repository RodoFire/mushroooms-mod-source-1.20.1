...
public class ModItems {
    ...
    public static final Item PINK_MUSHROOM_VINES_ITEM = registerItem("pink_mushroom_vines_item",
            (Item) new AliasedBlockItem(Blocks.CAVE_VINES, new FabricItemSettings()));
    public static final Item BIG_PURPLE_MUSHROOM_SEED = registerItem("big_purple_mushroom_seed",
            new AliasedBlockItem(ModBlocks.BIG_PURPLE_MUSHROOM_PLANT, new FabricItemSettings()));
    public static final Item BIG_GREEN_MUSHROOM_SEED = registerItem("big_green_mushroom_seed",
            new AliasedBlockItem(ModBlocks.BIG_GREEN_MUSHROOM_PLANT, new FabricItemSettings()));
